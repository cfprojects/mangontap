...
This plugin downloads and installs 
the Mango Blog application created by Laura Arguello 
...
The root /mangontap/ directory in the zip archive should 
be directly underneath the plugin source directory, i.e. 
[ontap]/_tap/admin/plugins/source/mangontap 
